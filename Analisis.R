...
notas.infor <- read.csv2(file = "./input-data/ANALISIS I INFOR.csv")
notas.indus <- read.csv2(file = "./input-data/ANALISIS I INDUSTRI.csv")
...
write.xlsx(notas.infor, "./output-data/ANALISIS INFORMATICOS-ANON.xlsx")

write.xlsx(notas.indus, "./output-data/ANALISIS I INDUSTRIALES-ANON.xlsx")
